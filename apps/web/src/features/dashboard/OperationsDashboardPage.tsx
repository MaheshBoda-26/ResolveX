...
export function OperationsDashboardPage() {
  ...
  const filteredCases = cases.filter((c) => {
    ...
    if (filter === "Resolved")
      return (
        c.status === "Autonomous Resolved" || c.status === "Policy Verified"
      );
    return true;
  });
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="p-4 rounded-xl border border-outline-variant/50 bg-surface-container-low/40 flex flex-col justify-between">
            ...
            <div className="mt-3 pt-3 border-t border-outline-variant/30 flex justify-between text-xs font-mono">
              <span className="text-on-surface-variant">
                Confidence:{" "}
                <strong className="text-on-surface font-bold">99.4%</strong>
              </span>
              <span className="text-on-surface-variant">
                Handled:{" "}
                <strong className="text-on-surface font-bold">142</strong>
              </span>
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl border border-outline-variant/50 bg-surface-container-low/40 flex flex-col justify-between">
            ...
            <div className="mt-3 pt-3 border-t border-outline-variant/30 flex justify-between text-xs font-mono">
              <span className="text-on-surface-variant">
                Confidence:{" "}
                <strong className="text-on-surface font-bold">96.2%</strong>
              </span>
              <span className="text-on-surface-variant">
                Handled:{" "}
                <strong className="text-on-surface font-bold">89</strong>
              </span>
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl border border-outline-variant/50 bg-surface-container-low/40 flex flex-col justify-between">
            ...
            <div className="mt-3 pt-3 border-t border-outline-variant/30 flex justify-between text-xs font-mono">
              <span className="text-on-surface-variant">
                Confidence:{" "}
                <strong className="text-on-surface font-bold">94.8%</strong>
              </span>
              <span className="text-on-surface-variant">
                Handled:{" "}
                <strong className="text-on-surface font-bold">61</strong>
              </span>
            </div>
          </div>
        </div>
