...
export function CaseDetailPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    "Timeline" | "Actions" | "Policy" | "Notes"
  >("Timeline");
  const [noteText, setNoteText] = useState("");
  const [notes, setNotes] = useState([
    {
      id: "1",
      author: "AI Agent (Billing Engine)",
      text: "Detected duplicate charge pattern on Stripe transaction ch_3N8xY291.",
      time: "10:42:05 AM",
    },
    {
      id: "2",
      author: "Human Supervisor (Alex M.)",
      text: "Verified customer Gold Tier standing. Approved refund exception.",
      time: "10:44:12 AM",
    },
  ]);
                ...
                timeline: [
                  {
                    ...
                    description:
                      "Identified duplicate charge issue for Order #84920 ($120.00).",
                  ...
                  },
                  {
                    ...
                    description:
                      "Stripe API confirms 2 authorization holds within 45 seconds.",
                  ...
                  },
                  {
                    ...
                    description:
                      "POL-PAY-204 passed: Automatic refund eligible for <$250 duplicate.",
                  ...
                  },
                  {
                    ...
                    description:
                      "Initiate immediate $120.00 refund to original payment method.",
                  ...
                  },
                  {
                    ...
                    description:
                      "Triggering Stripe Refund Endpoint (tx_ref_99401)...",
                  ...
                  },
                  {
                    ...
                    description:
                      "Verify refund status & update customer ledger.",
                    timestamp: "Completed",
                  },
                  {
                    step: "Resolve",
                    ...
                    description:
                      "Send confirmation summary to customer & close case.",
                    timestamp: "Completed",
                  },
                ],
                actions: [
                  {
                    ...
                    endpoint: "/v1/refunds",
                    description:
                      "Stripe Refund Endpoint • Charge #ch_3N8xY291 ($120.00)",
                    status: "200 OK",
                  },
                  {
                    method: "POST",
                    ...
                    description:
                      "Send refund confirmation receipt to s.jenkins@example.com",
                    status: "200 OK",
                  },
                ],
                policies: [
                  {
                    policy: "POL-PAY-204: Duplicate Charge Eligibility",
                    description:
                      "Duplicate charges under $250 qualify for automated refund execution.",
                    status: "PASSED",
                  },
                  {
                    policy: "POL-AUTH-102: Identity & Card Matching",
                    description:
                      "Verified payment method owner matches customer profile Sarah Jenkins.",
                    status: "PASSED",
                  },
                ],
                notes: [
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="flex items-center gap-2 border-b border-outline-variant/40 pb-2">
            {(["Timeline", "Actions", "Policy", "Notes"] as const).map(
              (tab) => (
                <button
                  key={tab}
            ...
            <div className="bg-surface-container-lowest border border-outline-variant/60 rounded-xl p-5 shadow-xs space-y-4">
              ...
              <div className="space-y-2">
                <div className="p-3 rounded-lg border border-emerald-500/30 bg-emerald-500/5 text-xs flex justify-between items-center">
                  <div>
                    <span className="font-bold text-emerald-700 dark:text-emerald-400">
                      POL-PAY-204: Duplicate Charge Eligibility
                    </span>
                    <p className="text-on-surface-variant text-[11px] mt-0.5">
                      Duplicate charges under $250 qualify for automated refund
                      execution.
                    </p>
                  </div>
                ...
                <div className="p-3 rounded-lg border border-emerald-500/30 bg-emerald-500/5 text-xs flex justify-between items-center">
                  <div>
                    <span className="font-bold text-emerald-700 dark:text-emerald-400">
                      POL-AUTH-102: Identity & Card Matching
                    </span>
                    <p className="text-on-surface-variant text-[11px] mt-0.5">
                      Verified payment method owner matches customer profile
                      Sarah Jenkins.
                    </p>
                  </div>
                  <span className="font-bold text-emerald-600">PASSED</span>
            ...
            <div className="bg-surface-container-lowest border border-outline-variant/60 rounded-xl p-5 shadow-xs space-y-4">
              ...
              <div className="space-y-3">
                {notes.map((n) => (
                  <div
                    key={n.id}
                    className="p-3 rounded-lg bg-surface-container-low border border-outline-variant/40 text-xs"
                  >
